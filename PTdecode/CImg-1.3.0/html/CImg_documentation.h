...
/**
   ...
   A partial translation in Chinese is <a href="../CImg_reference_chinese.pdf">available here</a>.
...
/*----------------------------------
  ...
  CImg<T> : The image structure

  --------------------------------*/

/** \addtogroup cimg_structure CImg<T> : The image structure. */
/*@{*/
/**
   ...
   \section cs0 Structure overview

   \section cs1 Image construction/destruction/copy

   \section cs2 Image methods

   \section cs3 Shared images

   \section cs4 Low-level structure
...
/*----------------------------------------
  ...
  CImgList<T> : The image list structure

  ---------------------------------------*/

/** \addtogroup cimglist_structure CImgList<T> : The image list structure. */
/*@{*/
/**
   ...
   \section cls0 Structure overview

   \section cls1 Image list construction/destruction/copy

   \section cls2 Image methods

   \section cls4 Low-level structure
...
/*----------------------------------------------
  ...
  CImgDisplay : The image display structure

  --------------------------------------------*/

/** \addtogroup cimgdisplay_structure CImgDisplay : The image display structure. */
/*@{*/
/**
   ...
   \section cds0 Structure overview

   \section cds1 Image display construction/destruction/copy

   \section cds2 Image methods

   \section cds4 Low-level structure
...
/*----------------------------------------------
  ...
  CImgException : The library exception structure

  --------------------------------------------*/

/** \addtogroup cimgexception_structure CImgException : The library exception structure. */
/*@{*/
/**
   ...
   \section ces0 Structure overview
...
/**
  ...
  \code visu.fill(0).draw_graph(image.get_crop(0,y,0,0,image.dimx()-1,y,0,0),red,1,0,256,0); \endcode
  ...
  \code visu.draw_graph(image.get_crop(0,y,0,1,image.dimx()-1,y,0,1),green,1,0,256,0); \endcode
  Plot the intensity profile for the green channel of the clicked line.
  \code visu.draw_graph(image.get_crop(0,y,0,2,image.dimx()-1,y,0,2),blue,1,0,256,0).display(draw_disp); \endcode
...
/**
  ...
  retrieved by the function CImg<T>::ptr().
  ...
  so, 'T *ptr = img.ptr()' gives you the pointer to the first value of the image 'img'. The overall size of the used memory for one
  ...
  width=depth=dim=1 can be accessed by 'img(y)' instead of 'img(0,y)'. This is very convenient.
